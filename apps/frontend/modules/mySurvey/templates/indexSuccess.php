                ...
                <fieldset class="disp-block">
                    ...
                    <form action="" name="" id="display_form" method="POST" target="_blank">
                        ...
                        <div class="fifth-column">                            
                            ...
                            <input title="Plan to pursue this award." name="display[my_status]" display_name="my_status" type="checkbox" class="not_default_display_checkbox" col_num="12" value="1" />
                            <span title="Plan to pursue this award.">My Status</span><br />
