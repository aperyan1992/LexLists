    ...
    <tr>
        ...
        <td> 
            ...
            <?php if($name == "groups_list") : ?>
                <?php if(sfContext::getInstance()->getRouting()->getCurrentRouteName() == 'sf_guard_user_edit' || sfContext::getInstance()->getRouting()->getCurrentRouteName() == 'sf_guard_user_update') : ?>
