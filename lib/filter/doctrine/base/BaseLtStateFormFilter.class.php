...
/**
 * LtState filter form base class.
 *
 * @package    LexLists
 * @subpackage filter
 ...
 */
abstract class BaseLtStateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lt_state_filters[%s]');
  ...
  public function addSurveyStatesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('LtSurveyState.survey_id', $values)
    ;
  }
