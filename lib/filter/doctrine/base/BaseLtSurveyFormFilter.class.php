...
abstract class BaseLtSurveyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'year'                   => new sfWidgetFormFilterInput(),//sfCustomWidgetFormChoice(array("choices" => $years_range_array,"add_empty" => ""), array("style" => "width: 60px !important;")),
    ...
    $this->setValidators(array(
      ...
      'year'                   => new sfValidatorPass(array('required' => false)), //new sfValidatorChoice(array('choices' => array_keys($years_range_array), 'required' => false), array("required" => "This field is required.")),
