...
/**
 * LtMySurveyNote form base class.
 *
 * @method LtMySurveyNote getObject() Returns the current form's model object
 *
 * @package    LexLists
 * @subpackage form
 ...
 */
abstract class BaseLtMySurveyNoteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lt_my_survey_note[%s]');
